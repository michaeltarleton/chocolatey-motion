...
$url        = 'https://github.com/usemotion/desktopapp/releases/download/0.71.0/motion-0.71.0.x64.msix' # download url, HTTPS preferred
$url64      = 'https://github.com/usemotion/desktopapp/releases/download/0.71.0/motion-0.71.0.x64.msix' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
...
$packageArgs = @{
  ...
  softwareName  = 'motion*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  ...
  checksum      = '80DBC16EE4811E45FB74637D2593BB05D00A6AFF46B2EA3256FE6494B73CC6D6'
  checksumType  = 'sha256' #default is md5, can also be sha1, sha256 or sha512
  checksum64    = '80DBC16EE4811E45FB74637D2593BB05D00A6AFF46B2EA3256FE6494B73CC6D6'
